# Eskom Energy CRISIS POWER SUPPLY VS DEMAND BALANCE (Power BI Project)
...
Total and residual energy demand

Daily average generation

Dispatchable generation data

Renewable energy generation by technology

Capacity utilization by source (e.g., CSP, hydro, wind)

Seasonal and time-of-day consumption patterns
...
Demand and generation levels fluctuate significantly by season and time of day.

Residual demand, which represents demand minus renewable and other non-dispatchable sources, is often high—posing challenges for grid reliability.
...
Matrix Table (Interactive): Shows energy consumption across 4 seasons, split by day/night, enabling insights into seasonal behavior.

Donut Chart: Breaks down renewable energy generation by technology, reinforcing the need for sustainable alternatives.

Line Graph: Displays trends of residual demand vs dispatchable generation from 2021 to 2025.

Positive-Negative Area Chart: Highlights periods of surplus or shortage in energy balance.

Cluster Bar Graph: Reveals CSP (Concentrated Solar Power) generation and capacity utilization trends over time.

Cards:

Peak Residual Demand: 34.03k
...
Renewables remain a small but crucial component of the generation mix.

Residual demand frequently exceeds dispatchable capacity, risking blackouts and load-shedding especially during COVID-19 era.
...
Handling missing or inconsistent time-series data

Disaggregating energy types and demand into usable categories

Solutions:

Used Power Query to build a robust data cleaning pipeline
...
Applying predictive models to forecast demand and renewable output
...
DAX Guide: https://learn.microsoft.com/en-us/dax/ 
